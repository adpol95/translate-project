export default function DelBtn(props) {
    return (
        <button
            ...
            className={`${props.hy} bg-orange absolute mt-[-20vw] group-hover:mt-[1em] pb-4 pt-[4em] w-[150%] left-[-.7em] rounded-b-lg flex-col items-end transition-[margin-top] duration-500`}
            onClick={() => {
